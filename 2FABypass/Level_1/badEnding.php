        ...
        <div class="box-login-register d-flex justify-content-center ">
            ...
            <div class="Login-Register align-self-center mb-5">
                ...
                <div class="input-group-plus">
                    ...
                    <br>
                    <p class="d-flex justify-content-center fw-bold fs-5">Nice try but this is not the correct code.</p>
                    <br>
                    <div class="input-group-plus ">
                    <p class="d-flex justify-content-center mr-3 "><a href="../Level_1/index.php" class="btn btn-info" role="button" data-bs-toggle="button">RESTART</a></p>
