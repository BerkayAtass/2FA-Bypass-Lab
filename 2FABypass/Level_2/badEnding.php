...
$gifNames = array('rock', 'stop1', 'stop2', 'stop3');
        ...
        <div class="box-login-register d-flex justify-content-center ">
            ...
            <div class="Login-Register align-self-center mb-5">
                ...
                <div>
                    ...
                    <br>
                    <div class="input-group-plus ">
                    <p class="d-flex justify-content-center mr-3 "><a href="../Level_2/index.php" class="btn btn-info" id="restart" role="button" data-bs-toggle="button">RESTART</a></p>
