        ...
        <div class="box-login-register d-flex justify-content-center ">
            ...
            <div class="Login-Register align-self-center mb-5">
                ...
                <div class="input-group-plus">
                    ...
                    <p class="d-flex justify-content-center fw-bold fs-5">Level 3 has been completed successfully.</p>
                    <br>
                    <div class="input-group-plus ">
                    <p class="d-flex justify-content-center mr-3 "><a href="../Level_4/index.php" class="btn btn-info" role="button" data-bs-toggle="button">LEVEL 4</a></p>
